...
const Signup = () => {
    ...
    if (redirct) return <Redirect to="/login" />
                ...
                <div className="card card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <input type="text" name="name" value={name} onChange={handleName} className="form-contol"/>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <input type="password" name="confirmPassword" value={confirmPassword} onChange={handleConfirmPassword} className="form-contol"/>
                        </div>
                    </form>
                </div>
            </div>
